...
public class Piece {
	...
	// constructor
	public Piece(int xTile, int yTile, boolean colour, int type, int imageNum, int pieceNum) {
	...
	public void loadMoves() {
		if (type == 0) {
			RookMoves.addRookMoves(xTile, yTile, currentPossibleXMoves, currentPossibleYMoves, colour);
		} else if (type == 1) {
			KnightMoves.addKnightMoves(xTile, yTile, currentPossibleXMoves, currentPossibleYMoves, colour);
		} else if (type == 2) {
			BishopMoves.addBishopMoves(xTile, yTile, currentPossibleXMoves, currentPossibleYMoves, colour);
		} else if (type == 3) {
			RookMoves.addRookMoves(xTile, yTile, currentPossibleXMoves, currentPossibleYMoves, colour);
			BishopMoves.addBishopMoves(xTile, yTile, currentPossibleXMoves, currentPossibleYMoves, colour);
		} else if (type == 4) {
			...
			PawnMoves.addPawnMoves(xTile, yTile, currentPossibleXMoves, currentPossibleYMoves, colour);
		}
