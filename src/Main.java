...
public class Main extends JPanel implements Runnable {
    ...
    // pieces
    Piece wr1 = new Piece(0, 7, true, 0, 0, 0);
    Piece wr2 = new Piece(7, 7, true, 0, 0, 1);
    Piece wn1 = new Piece(1, 7, true, 1, 1, 2);
    Piece wn2 = new Piece(6, 7, true, 1, 1, 3);
    Piece wb1 = new Piece(2, 7, true, 2, 2, 4);
    Piece wb2 = new Piece(5, 7, true, 2, 2, 5);
    Piece wk = new Piece(4, 7, true, 4, 4, 6);
    Piece wq = new Piece(3, 7, true, 3, 3, 7);
    Piece br1 = new Piece(0, 0, false, 0, 5, 8);
    Piece br2 = new Piece(7, 0, false, 0, 5, 9);
    Piece bn1 = new Piece(1, 0, false, 1, 6, 10);
    Piece bn2 = new Piece(6, 0, false, 1, 6, 11);
    Piece bb1 = new Piece(2, 0, false, 2, 7, 12);
    Piece bb2 = new Piece(5, 0, false, 2, 7, 13);
    Piece bk = new Piece(4, 0, false, 4, 9, 14);
    Piece bq = new Piece(3, 0, false, 3, 8, 15);
    // lots of pawns
    Piece wp1 = new Piece(0, 6, true, 5, 10, 16);
    Piece wp2 = new Piece(1, 6, true, 5, 10, 17);
    Piece wp3 = new Piece(2, 6, true, 5, 10, 18);
    Piece wp4 = new Piece(3, 6, true, 5, 10, 19);
    Piece wp5 = new Piece(4, 6, true, 5, 10, 20);
    Piece wp6 = new Piece(5, 6, true, 5, 10, 21);
    Piece wp7 = new Piece(6, 6, true, 5, 10, 22);
    Piece wp8 = new Piece(7, 6, true, 5, 10, 23);
    Piece bp1 = new Piece(0, 1, false, 5, 11, 24);
    Piece bp2 = new Piece(1, 1, false, 5, 11, 25);
    Piece bp3 = new Piece(2, 1, false, 5, 11, 26);
    Piece bp4 = new Piece(3, 1, false, 5, 11, 27);
    Piece bp5 = new Piece(4, 1, false, 5, 11, 28);
    Piece bp6 = new Piece(5, 1, false, 5, 11, 29);
    Piece bp7 = new Piece(6, 1, false, 5, 11, 30);
    Piece bp8 = new Piece(7, 1, false, 5, 11, 31);
    ...
    public void update() {
        ...
        if (turn == false) {
            ...
            Main.pieces.get(rand.nextInt(pieces.size())).xTile = Piece.allPossibleXMovesBlack
                    .get(rand.nextInt(Piece.allPossibleXMovesBlack.size()));
            Main.pieces.get(rand.nextInt(pieces.size())).yTile = Piece.allPossibleYMovesBlack
                    .get(rand.nextInt(Piece.allPossibleYMovesBlack.size()));
            // clear possible moves
            Piece.currentPossibleXMoves.clear();
            Piece.currentPossibleYMoves.clear();
            // set stuff to default
            Main.pieces.get(rand.nextInt(pieces.size())).holding = false;
            Main.pieces.get(rand.nextInt(pieces.size())).showing = false;
            // flip turn
            Main.turn = !Main.turn;
